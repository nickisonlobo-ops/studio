-- ============================================================
-- Atualiza apenas as funções e o trigger.
-- Seguro para rodar em projeto que já tem as tabelas criadas.
-- ============================================================

-- ── setup_admin_account ───────────────────────────────────────
-- Cria a empresa e vincula ao profile do admin.
-- Chamada pelo register() logo após o signUp.
...
-- Admin (sem empresa_id no metadata): profile sem empresa_id
-- Funcionário (com empresa_id no metadata): profile com empresa_id
